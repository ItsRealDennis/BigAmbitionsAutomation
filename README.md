...
| ⚖️ | **Service fee** *(opt-in)* | Optional challenge: charges in-game cash per automation run so leaning on the bot isn't free. Off by default; tune the fee in the panel. |
